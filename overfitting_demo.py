...
print("-> Kết quả: Sai số trên tập Test giảm mạnh, R2 tập Test được cải thiện rõ rệt.")
print("   Mô hình nâng cao khả năng tổng quát hóa (Generalization) và khắc phục thành công hiện tượng quá khớp (Overfitting).")
print("=" * 60)